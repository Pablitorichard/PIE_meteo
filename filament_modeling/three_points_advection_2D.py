...
Three time points semi-Lagrangian scheme in 2D with forcings. 
...
Nx = 200 # Number of zonal points.
Ny = 200 # Number of meridional points.
...
F = np.zeros((Nx,Ny,Nt+1)) # We need a +1 in dimension as we need an initial
