...
Lx = 2048# Zonal length of the domain 
Ly = 1024 # Meridional length of the domain

Nx = 256 # Number of zonal points.
Ny = 256 # Number of meridional points.
...
U = 16.3299*np.ones((2,Nx,Ny,Nt)) # Array of velocities. The velocity is uniform
# in time and space. 
