...
def pseudo_spectral_wind(history, grid, params, verbose, **kwargs):
    ...
    ut, vt = geostwind(grid.Lx, grid.Ly, current_state.vrs['theta_t'], z=0, verbose=verbose)
    us, vs = geostwind(grid.Lx, grid.Ly, current_state.vrs['theta_t'], z=params['z_star'], verbose=verbose)
