...
def wrap_advection_step_3P(history, grid, params, alpha_method, order_alpha, F_method, **kwargs):
	...
	a_ut, a_vt, the_new = \
	advection_step_3P(pre_state.vrs['alpha_ut'], pre_state.vrs['alpha_vt'], pre_state.vrs['theta'], dt, cur_state.vrs['ut'], cur_state.vrs['vt'], grid.dx, grid.dy, alpha_method, order_alpha, F_method)
	
	a_us, a_vs, dz_new = \
	advection_step_3P(pre_state.vrs['alpha_us'], pre_state.vrs['alpha_vs'], pre_state.vrs['Delta_z'], dt, cur_state.vrs['us'], cur_state.vrs['vs'], grid.dx, grid.dy, alpha_method, order_alpha, F_method)
    ...
    cur_state['alpha_ut'] = a_ut
    cur_state['alpha_vt'] = a_vt
    cur_state['alpha_us'] = a_us
    cur_state['alpha_vs'] = a_vs
    
    new_state['theta_t'] = the_new
    new_state['Delta_z'] = dz_new # Pas sûr !
